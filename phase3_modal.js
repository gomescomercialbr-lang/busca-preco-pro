...
const target = path.join(__dirname, '..', 'buscapreco_pro', 'src', 'app', 'page.tsx');
          ...
          {!searched && (
              <div className="space-y-4 animate-in fade-in slide-in-from-top-4 duration-1000">
                  ...
                  <h1 className="text-7xl md:text-9xl font-black tracking-tighter text-zinc-900 dark:text-white leading-[0.8]">
                    PESQUISA<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">LEGAL</span>
                  </h1>
                  
                  <p className="text-base md:text-lg text-zinc-500 dark:text-zinc-400 max-w-xl mx-auto font-medium">
                    Consolide mapas de preços com segurança jurídica e precisão estatística.
                  </p>
              </div>
          )}
      ...
      <div className="hidden print:block p-12 border-b-4 border-zinc-900 mb-12">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-lg font-bold uppercase tracking-widest text-zinc-500">BuscaPreço Pro • Relatório de Pesquisa Eletrônica</p>
            </div>
...
console.log('page.tsx updated with modal and advanced PDF layout.');
